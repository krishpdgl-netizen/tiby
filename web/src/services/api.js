...
export const processMeetingNotes = (blob,title) => { const f=new FormData(); f.append('file',blob,'notes.jpg'); return api.post(`/meetings/notes?title=${encodeURIComponent(title||'Meeting')}`,f) }
